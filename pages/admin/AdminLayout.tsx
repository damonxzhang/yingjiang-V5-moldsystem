...
const AdminLayout: React.FC<AdminLayoutProps> = ({ userRole, onLogout }) => {
  ...
  const menuItems = [
    ...
    { id: 'product_type_manage', name: '产品类型管理', icon: 'fa-box', permission: Permission.MACHINE_CONFIG },
  ...
  const renderContent = () => {
    ...
    switch(activePage) {
      ...
      case 'product_type_manage': return <ProductTypeManagement />;
