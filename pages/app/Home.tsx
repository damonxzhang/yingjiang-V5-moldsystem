...
const Home: React.FC<HomeProps> = ({ userRole, onNavigate }) => {
  const actions = [
    { id: 'inquiry', name: '模具查询', icon: 'fa-search', color: 'bg-indigo-500', roles: ['ADMIN', 'MOLD_ENGINEER_BIG', 'MOLD_ENGINEER_SMALL', 'OPERATOR', 'SHIFT_LEADER', 'SUPER_ADMIN', 'MAINTAINER'] },
    { id: 'transfer', name: '模具转换', icon: 'fa-exchange-alt', color: 'bg-green-500', roles: ['ADMIN', 'OPERATOR', 'MOLD_ENGINEER_BIG', 'MOLD_ENGINEER_SMALL', 'SHIFT_LEADER', 'SUPER_ADMIN', 'MAINTAINER'] },
    { id: 'maintenance', name: '保养执行', icon: 'fa-tools', color: 'bg-amber-500', roles: ['ADMIN', 'SHIFT_LEADER', 'MOLD_ENGINEER_BIG', 'MOLD_ENGINEER_SMALL', 'SUPER_ADMIN', 'MAINTAINER'] },
    { id: 'repair', name: '维修执行', icon: 'fa-wrench', color: 'bg-red-500', roles: ['ADMIN', 'SHIFT_LEADER', 'MOLD_ENGINEER_BIG', 'MOLD_ENGINEER_SMALL', 'SUPER_ADMIN', 'MAINTAINER'] },
  ];
